...
SHADOWDARK.PREDEFINED_EFFECTS = {
	...
	abilityCheckBonus: {
		defaultValue: 1,
		effectKey: "system.roll.stat.bonus.all",
		img: "icons/skills/melee/hand-grip-staff-yellow-brown.webp",
		name: "SHADOWDARK.item.effect.predefined_effect.abilityCheckBonus",
		mode: "CONST.ACTIVE_EFFECT_MODES.ADD",
	},
	abilityCheckBonusCha: {
		defaultValue: 1,
		effectKey: "system.roll.stat.bonus.cha",
		img: "icons/skills/melee/hand-grip-staff-yellow-brown.webp",
		name: "SHADOWDARK.item.effect.predefined_effect.abilityCheckBonusCha",
		mode: "CONST.ACTIVE_EFFECT_MODES.ADD",
	},
	abilityCheckBonusCon: {
		defaultValue: 1,
		effectKey: "system.roll.stat.bonus.con",
		img: "icons/skills/melee/hand-grip-staff-yellow-brown.webp",
		name: "SHADOWDARK.item.effect.predefined_effect.abilityCheckBonusCon",
		mode: "CONST.ACTIVE_EFFECT_MODES.ADD",
	},
	abilityCheckBonusDex: {
		defaultValue: 1,
		effectKey: "system.roll.stat.bonus.dex",
		img: "icons/skills/melee/hand-grip-staff-yellow-brown.webp",
		name: "SHADOWDARK.item.effect.predefined_effect.abilityCheckBonusDex",
		mode: "CONST.ACTIVE_EFFECT_MODES.ADD",
	},
	abilityCheckBonusInt: {
		defaultValue: 1,
		effectKey: "system.roll.stat.bonus.int",
		img: "icons/skills/melee/hand-grip-staff-yellow-brown.webp",
		name: "SHADOWDARK.item.effect.predefined_effect.abilityCheckBonusInt",
		mode: "CONST.ACTIVE_EFFECT_MODES.ADD",
	},
	abilityCheckBonusStr: {
		defaultValue: 1,
		effectKey: "system.roll.stat.bonus.str",
		img: "icons/skills/melee/hand-grip-staff-yellow-brown.webp",
		name: "SHADOWDARK.item.effect.predefined_effect.abilityCheckBonusStr",
		mode: "CONST.ACTIVE_EFFECT_MODES.ADD",
	},
	abilityCheckBonusWis: {
		defaultValue: 1,
		effectKey: "system.roll.stat.bonus.wis",
		img: "icons/skills/melee/hand-grip-staff-yellow-brown.webp",
		name: "SHADOWDARK.item.effect.predefined_effect.abilityCheckBonusWis",
		mode: "CONST.ACTIVE_EFFECT_MODES.ADD",
	},
	acBonus: {
		defaultValue: 1,
